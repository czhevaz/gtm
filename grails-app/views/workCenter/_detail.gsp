...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="workCenter.qCHeaders.label" default="QCH eaders" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/QCHeader/jlist?masterField.name=workCenter&masterField.id=${workCenterInstance?.id}'">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'workCenterId',hidden:true">Work Center</th>
        ...
        <r:script>     
            ...
            function qCHeadersAppend(){
                if (qCHeadersEndEditing()){
                    ...
                    {workCenterId: ${workCenterInstance.id? workCenterInstance.id : 0} });
