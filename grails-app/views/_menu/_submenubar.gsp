...
<g:if test="${	params.controller != null
	...
	<ul id="Menu" class="nav nav-pills">
		...
		<g:set var="entityName" value="${message(code: params.controller+'.label', default: params.controller=='gallon'?session.trackedItem:params.controller.substring(0,1).toUpperCase() + params.controller.substring(1).toLowerCase())}" />
