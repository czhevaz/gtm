<%@ page import="com.smanggin.trackingmanagement.Line" %>
			...
			<div class="form-group fieldcontain ${hasErrors(bean: lineInstance, field: 'plant', 'error')} required">
				...
				<div class="col-sm-9">
					<g:select id="plant" name="plant.serverId" from="${com.smanggin.trackingmanagement.Plant.list()}" optionKey="serverId" optionValue="code" value="${lineInstance?.plant?.serverId}" class="many-to-one form-control chosen-select"/>
