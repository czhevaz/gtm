...
<div class="easyui-tabs table" style="height:300px">
        ...
        <div title='<g:message code="transactionGroup.productionInHeaders.label" default="Production In Headers" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/productionInHeader/jlist?masterField.name=transactionGroup&masterField.id=${transactionGroupInstance?.id}'">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'transactionGroupId',hidden:true">Transaction Group</th>
        ...
        <div title='<g:message code="transactionGroup.qCHeaders.label" default="QCH eaders" />' style="padding:10px">
            ...
            url:'/${meta(name:'app.name')}/QCHeader/jlist?masterField.name=transactionGroup&masterField.id=${transactionGroupInstance?.id}'">
                <thead>
                    <tr>
        ...
        <r:script>     
            ...
            function productionInHeadersEndEditing(){
                ...
                if ($('#dg-productionInHeaders').datagrid('validateRow', editIndex)){
                    ...
                    //plantName
                    var ed = $('#dg-productionInHeaders').datagrid('getEditor', {index:editIndex,field:'plantId'});
                    var plantName = $(ed.target).combobox('getText');
                    $('#dg-productionInHeaders').datagrid('getRows')[editIndex]['plantName'] = plantName;
            ...
            function productionInHeadersAppend(){
                if (productionInHeadersEndEditing()){
                    ...
                    {transactionGroupId: ${transactionGroupInstance.id? transactionGroupInstance.id : 0} });
